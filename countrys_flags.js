...
function getCountry(countryName) {
     // Check if the countryName is in the dictionary
  if (countriesFlags.hasOwnProperty(countryName)) {
    // Check if "normal" URL exists, otherwise use "mini" URL
    if (countriesFlags[countryName].hasOwnProperty("normal")) {
      return countriesFlags[countryName]["normal"];
    } else if (countriesFlags[countryName].hasOwnProperty("mini")) {
      return countriesFlags[countryName]["mini"];
    }
    }
}
